...
<body class="selection:bg-gray-900 selection:text-white dark:selection:bg-white dark:selection:text-gray-900">
   <section id="login" class="login-section px-8 bg-primary-500 dark:bg-gray-900 font-noto min-h-screen flex justify-center items-center">
      <div class="grid max-w-screen-xl  rounded-xl mx-auto z-10 lg:gap-8 xl:gap-0 lg:grid-cols-10">
         <div class="hidden p-16 border border-y-[14px] border-l-[14px] border-white rounded-l-lg lg:mt-0 lg:col-span-5 lg:flex">
            <img src="../assets/img/login.svg" class="w-96" alt="Tech Company Vector">
         </div>
         <div class="bg-white rounded-r-lg p-4 space-y-4 md:space-y-6 lg:p-8 lg:col-span-5">
            <div class="space-y-2">
            ...
            <form class="space-y-4 md:space-y-6" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
               ...
               <button type="submit" class="w-full text-white bg-primary-500 transition-all duration-300 hover:bg-primary-600 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Sign in</button>
               <p class="text-sm font-light text-gray-500 dark:text-gray-400">
                  Don’t have an account yet? <a href="./register-1.php" class="font-medium text-primary-600 hover:underline dark:text-primary-500">Sign up</a>
               </p>
            </form>
         </div>
      </div>
